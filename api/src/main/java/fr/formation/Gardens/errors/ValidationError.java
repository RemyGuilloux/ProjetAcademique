package fr.formation.Gardens.errors;
...
public class ValidationError {
	...
	/**
	 * Returns the attribute name, global validator name in case of global error.
	 *
	 ...
	 */
	public static ValidationError ofGlobalType(String object, String attribute, String detail) {
	 ...
	 */
	public static ValidationError ofFieldType(String object, String attribute, String detail) {
	...
	public String toString() {
		return "{object=" + object + ", attribute=" + attribute + ", code=" + code + ", type=" + type + "}";
	}
